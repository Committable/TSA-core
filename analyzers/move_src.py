...
from move_parser import parser as move_parser
from move_parser import walker as move_walker


def analyze_move_code_from_treesitter(output_path,
                                      src_path,
                                      project_path,
                                      context,
    ...
    sourceUnit = None
    try:
        sourceUnit = move_parser.parse(source.get_content())
    ...
    # 2. get report
    ast_walker = move_walker.MoveAstWalker()
