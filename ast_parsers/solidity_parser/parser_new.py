...
from antlr4 import *
from ast_parsers.solidity_parser.solidity_antlr4_new.SolidityLexer import SolidityLexer
from ast_parsers.solidity_parser.solidity_antlr4_new.SolidityParser import SolidityParser
from ast_parsers.solidity_parser.solidity_antlr4_new.SolidityVisitor import SolidityVisitor
...
class AstVisitor(SolidityVisitor):
    ...
    def visitAssemblyFunctionDefinition(self, ctx):
        ...
        if ctx.assemblyFunctionReturns():
            returnArgs = self.visit(ctx.assemblyFunctionReturns().
