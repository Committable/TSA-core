...
class SolidityListener(ParseTreeListener):
    ...
    def enterVersionConstraint(self,
                               ctx: SolidityParser.VersionConstraintContext):
        pass

    # Exit a parse tree produced by SolidityParser#versionConstraint.
    def exitVersionConstraint(self,
                              ctx: SolidityParser.VersionConstraintContext):
        pass

    # Enter a parse tree produced by SolidityParser#importDeclaration.
    def enterImportDeclaration(self,
                               ctx: SolidityParser.ImportDeclarationContext):
        pass
    ...
    def exitContractDefinition(self,
                               ctx: SolidityParser.ContractDefinitionContext):
        pass
    ...
    def enterFileLevelConstant(self,
                               ctx: SolidityParser.FileLevelConstantContext):
        pass

    # Exit a parse tree produced by SolidityParser#fileLevelConstant.
    def exitFileLevelConstant(self,
                              ctx: SolidityParser.FileLevelConstantContext):
        pass
    ...
    def enterUsingForDeclaration(
            self, ctx: SolidityParser.UsingForDeclarationContext):
        pass

    # Exit a parse tree produced by SolidityParser#usingForDeclaration.
    def exitUsingForDeclaration(self,
                                ctx: SolidityParser.UsingForDeclarationContext):
        pass
    ...
    def exitModifierDefinition(self,
                               ctx: SolidityParser.ModifierDefinitionContext):
        pass
    ...
    def exitModifierInvocation(self,
                               ctx: SolidityParser.ModifierInvocationContext):
        pass
    ...
    def exitFunctionDefinition(self,
                               ctx: SolidityParser.FunctionDefinitionContext):
        pass

    # Enter a parse tree produced by SolidityParser#functionDescriptor.
    def enterFunctionDescriptor(self,
                                ctx: SolidityParser.FunctionDescriptorContext):
        pass

    # Exit a parse tree produced by SolidityParser#functionDescriptor.
    def exitFunctionDescriptor(self,
                               ctx: SolidityParser.FunctionDescriptorContext):
        pass

    # Enter a parse tree produced by SolidityParser#returnParameters.
    def enterReturnParameters(self,
                              ctx: SolidityParser.ReturnParametersContext):
        pass
    ...
    def enterEventParameterList(self,
                                ctx: SolidityParser.EventParameterListContext):
        pass

    # Exit a parse tree produced by SolidityParser#eventParameterList.
    def exitEventParameterList(self,
                               ctx: SolidityParser.EventParameterListContext):
        pass
    ...
    def enterVariableDeclaration(
            self, ctx: SolidityParser.VariableDeclarationContext):
        pass
    ...
    def enterUserDefinedTypeName(
            self, ctx: SolidityParser.UserDefinedTypeNameContext):
        pass

    # Exit a parse tree produced by SolidityParser#userDefinedTypeName.
    def exitUserDefinedTypeName(self,
                                ctx: SolidityParser.UserDefinedTypeNameContext):
        pass
    ...
    def enterMappingValueName(self,
                              ctx: SolidityParser.MappingValueNameContext):
        pass
    ...
    def enterFunctionTypeName(self,
                              ctx: SolidityParser.FunctionTypeNameContext):
        pass
    ...
    def enterUncheckedStatement(self,
                                ctx: SolidityParser.UncheckedStatementContext):
        pass

    # Exit a parse tree produced by SolidityParser#uncheckedStatement.
    def exitUncheckedStatement(self,
                               ctx: SolidityParser.UncheckedStatementContext):
        pass
    ...
    def enterDoWhileStatement(self,
                              ctx: SolidityParser.DoWhileStatementContext):
        pass
    ...
    def enterElementaryTypeName(self,
                                ctx: SolidityParser.ElementaryTypeNameContext):
        pass

    # Exit a parse tree produced by SolidityParser#elementaryTypeName.
    def exitElementaryTypeName(self,
                               ctx: SolidityParser.ElementaryTypeNameContext):
        pass
    ...
    def enterPrimaryExpression(self,
                               ctx: SolidityParser.PrimaryExpressionContext):
        pass

    # Exit a parse tree produced by SolidityParser#primaryExpression.
    def exitPrimaryExpression(self,
                              ctx: SolidityParser.PrimaryExpressionContext):
        pass
    ...
    def enterAssemblyExpression(self,
                                ctx: SolidityParser.AssemblyExpressionContext):
        pass

    # Exit a parse tree produced by SolidityParser#assemblyExpression.
    def exitAssemblyExpression(self,
                               ctx: SolidityParser.AssemblyExpressionContext):
        pass
    ...
    def enterAssemblyAssignment(self,
                                ctx: SolidityParser.AssemblyAssignmentContext):
        pass

    # Exit a parse tree produced by SolidityParser#assemblyAssignment.
    def exitAssemblyAssignment(self,
                               ctx: SolidityParser.AssemblyAssignmentContext):
        pass
    ...
    def enterOverrideSpecifier(self,
                               ctx: SolidityParser.OverrideSpecifierContext):
        pass

    # Exit a parse tree produced by SolidityParser#overrideSpecifier.
    def exitOverrideSpecifier(self,
                              ctx: SolidityParser.OverrideSpecifierContext):
        pass
