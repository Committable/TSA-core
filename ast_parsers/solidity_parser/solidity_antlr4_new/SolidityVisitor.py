...
class SolidityVisitor(ParseTreeVisitor):
    ...
    def visitContractDefinition(self,
    ...
    def visitFileLevelConstant(self,
    ...
    def visitEventParameterList(self,
    ...
    def visitUncheckedStatement(self,
    ...
    def visitDoWhileStatement(self,
    ...
    def visitElementaryTypeName(self,
    ...
    def visitAssemblyExpression(self,
    ...
    def visitAssemblyAssignment(self,
    ...
    def visitOverrideSpecifier(self,
