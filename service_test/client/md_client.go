...
func NewMdClient(endpoint string, timeout int) (*MdClient, error) {
	// 连接grpc服务器
	...
	// 初始化Greeter服务客户端
	c := pb.NewMdSourceCodeAnalysisClient(conn)
...
func (client *MdClient) Analyse(before, after *pb.AnalysisTarget, diff string) (*pb.SourceCodeAnalysisResponse, error) {
	// 初始化上下文，设置请求超时时间为1秒
...
func (client *MdClient) IsOk() bool {
