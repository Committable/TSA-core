...
class AstReporter:
    ...
    def dump_ast_json(self):
        ...
        with open(self.ast_json_path, 'w') as output_file:
    ...
    def dump_ast_edge_list(self):
        ...
        with open(self.ast_edge_list_path, 'w') as edgelist_file:
            edgelist_file.write("".join(self.ast_edge_list))

    def dump_ast_abstract(self):
        self.ast_abstract_path = os.path.join(self.output_path, "ast_abstract.json")
        with open(self.ast_abstract_path, 'w') as output_file:
