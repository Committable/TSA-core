...
from antlr4 import *
from solidity_parser.solidity_antlr4_new.SolidityLexer import SolidityLexer
from solidity_parser.solidity_antlr4_new.SolidityParser import SolidityParser
from solidity_parser.solidity_antlr4_new.SolidityVisitor import SolidityVisitor
...
class AstVisitor(SolidityVisitor):
    ...
    def visitAssemblyFunctionDefinition(self, ctx):
        ...
        if ctx.assemblyFunctionReturns():
            returnArgs = self.visit(ctx.assemblyFunctionReturns().assemblyIdentifierList().identifier())
        else:
            returnArgs = []
        # end debug
        return Node(ctx=ctx,
