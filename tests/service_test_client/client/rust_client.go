...
type RustClient struct {
	...
	endpoint string
	client   pb.RustSourceCodeAnalysisClient
	timeout int

	status bool
}

func NewRustClient(endpoint string, timeout int) (*RustClient, error) {
	// 连接grpc服务器
	...
	// 初始化Greeter服务客户端
	c := pb.NewRustSourceCodeAnalysisClient(conn)
...
func (client *RustClient) Analyse(before, after *pb.AnalysisTarget, diff string) (*pb.SourceCodeAnalysisResponse, error) {
	// 初始化上下文，设置请求超时时间为1秒
...
func (client *RustClient) IsOk() bool{
