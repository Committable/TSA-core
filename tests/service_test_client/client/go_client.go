...
type GoClient struct {
	...
	endpoint string
	client   pb.GoSourceCodeAnalysisClient
	timeout int

	status bool
}

func NewGoClient(endpoint string, timeout int) (*GoClient, error) {
	// 连接grpc服务器
	...
	// 初始化Greeter服务客户端
	c := pb.NewGoSourceCodeAnalysisClient(conn)
...
func (client *GoClient) Analyse(before, after *pb.AnalysisTarget, diff string) (*pb.SourceCodeAnalysisResponse, error) {
	// 初始化上下文，设置请求超时时间为1秒
...
func (client *GoClient) IsOk() bool{
